  ...
  return (
    <div className="fixed bottom-4 right-4 max-w-md bg-black text-white p-4 rounded-lg text-xs font-mono z-50 max-h-96 overflow-auto">
      ...
      <div className="mb-2">
        ...
        <div>
          Session Ready: {tagadaContext.isSessionInitialized ? "✅" : "❌"}
        </div>
      </div>
      ...
      <div className="mb-2">
        ...
        {directSDKProducts && directSDKProducts.length > 0 && (
          <div className="text-xs space-y-2">
            ...
            {directSDKProducts.slice(0, 1).map((product) => (
              <div
                key={product.id}
                className="p-2 bg-gray-800 rounded max-h-96 overflow-y-auto"
              >
                <div className="text-white font-bold">
                  🔍 COMPLETE PRODUCT DATA DUMP:
                </div>
                ...
                <div className="mt-2 text-blue-300">
                  ...
                  <div>Product Image: {(product as any).image || "null"}</div>
                  <div>
                    Product ImageUrl: {(product as any).imageUrl || "null"}
                  </div>
                  <div>
                    First Variant Image:{" "}
